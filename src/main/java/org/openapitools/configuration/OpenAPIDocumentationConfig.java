...
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2022-10-11T13:59:56.948016200-04:00[America/New_York]")
...
public class OpenAPIDocumentationConfig {
    ...
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.swaggerPetstoreOpenAPI30.base-path:/}") String basePath) {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("gen.petstore.api"))
                    .build()
